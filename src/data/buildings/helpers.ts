import {
  ...
  CATACOMBS_SOUL_COST,
  CATACOMBS_UPGRADE_COST, CHARNEL_HOUSE_BONES_PRODUCTION,
  CHARNEL_HOUSE_MAX_LEVEL,
  CHARNEL_HOUSE_MEAT_PRODUCTION, CHARNEL_HOUSE_PRODUCTION_TURNS,
  CHARNEL_HOUSE_UPGRADE_COST, OSSUARY_BONES_COST,
  OSSUARY_MAX_LEVEL, OSSUARY_UPGRADE_BONUS_BONES, OSSUARY_UPGRADE_BONUS_MEAT,
  OSSUARY_UPGRADE_COST,
  SOUL_WELL_MAX_LEVEL, SOUL_WELL_SOUL_PRODUCTION,
